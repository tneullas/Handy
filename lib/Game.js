...
(function() {
  ...
  Game = (function() {
    ...
    Game.prototype.configure = function() {
      ...
      this.cm.addVariableToShaders("tolExtraction", this.tolerance);
    ...
    Game.prototype.initKeyboard = function() {
      ...
      return document.onkeypress = function(evt) {
        ...
        if (keyCode === 80 || keyCode === 112) {
          ...
          return _this.background.init(_this.originalWebcamContext);
    ...
    Game.prototype.colorDetect = function() {
      var col, founded, imagedata, ind, limitFounded, pos, _i, _len;
      if (this.elementPicker.orderOfElement.length && this.elementPicker.orderOfElement[this.indicesOfLevel] !== void 0) {
        ...
        for (_i = 0, _len = pos.length; _i < _len; _i++) {
          ind = pos[_i];
          if (col.equalsWithTolerance([imagedata.data[ind], imagedata.data[ind + 1], imagedata.data[ind + 2], imagedata.data[ind + 3]], this.tolerance * 255)) {
            founded++;
    ...
    Game.prototype.draw = function() {
      if (this.webcam.video != null) {
        this.cm.drawScene(this.webcam.video, this.background.get());
      }
      this.clearCanvas();
