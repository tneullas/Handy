...
(function() {
  ...
  Game = (function() {
    ...
    Game.prototype.configure = function() {
      ...
      this.cm.addVariableToShaders("TOL", this.background.tolerance);
      _ref = this.elementPicker.elementList;
      _results = [];
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        el = _ref[i];
        _results.push(this.cm.addVariableToShaders("COL" + i, el.color));
      }
      return _results;
    };
    ...
    Game.prototype.colorDetect = function() {
      var col, elem, i, imagedata, _i, _len, _ref, _results, _step;
      imagedata = this.context.getImageData(0, 0, this.context.canvas.width, this.context.canvas.height);
      _ref = imagedata.data;
      _results = [];
      for (_i = 0, _len = _ref.length, _step = 4; _i < _len; _i += _step) {
        i = _ref[_i];
        _results.push((function() {
          var _j, _len1, _ref1, _results1;
          _ref1 = this.elementPicker.elementList;
          _results1 = [];
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            ...
            if (col.equalsWithTolerance([imagedata.data[i], imagedata.data[i + 1], imagedata.data[i + 2], imagedata.data[i + 3]], 100)) {
              _results1.push(console.log("color founded on pos ", i, col));
            } else {
    ...
    Game.prototype.draw = function() {
      ...
      this.clearCanvas();
      this.background.draw(this.context, this.webcam.video);
