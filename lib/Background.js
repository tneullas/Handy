...
(function() {
  ...
  Background = (function() {
    ...
    Background.prototype.extractBackgroundFromSourcePictures = function(context) {
      var dataTypedArray, i, j, median, sp, _i, _j, _len, _ref, _ref1;
      for (i = _i = 0, _ref = this.sourcePictures[0].length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        ...
        median.sort();
        this.extractedBackground[i] = median[Math.ceil(this.numberOfSourcePictures / 2)];
      }
      dataTypedArray = new Uint8Array(this.extractedBackground);
      return window.g.cm.addTextureToShaders("background", dataTypedArray);
    };
