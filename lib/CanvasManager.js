...
(function() {
  ...
  CanvasManager = (function() {
    ...
    CanvasManager.prototype.addVariableToShaders = function(name, value) {
      var variableIndex;
      variableIndex = this.gl.getAttribLocation(this.shaderProgram, name);
      this.gl.enableVertexAttribArray(variableIndex);
      return this.gl.vertexAttribPointer(variableIndex, value, this.gl.FLOAT, false, 0, 0);
    };
    ...
    CanvasManager.prototype.drawScene = function(video) {
      ...
      if (video != null) {
        ...
        mat4.translate(this.mvMatrix, [0.0, 0.0, -3.0]);
        this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.squareVertexPositionBuffer);
