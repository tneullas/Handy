...
(function() {
  ...
  Color = (function() {
    ...
    Color.prototype.equalsWithTolerance = function(colorAsArray, tolerance) {
      if ((colorAsArray[0] - tolerance) <= this.r && (colorAsArray[0] + tolerance) >= this.r && (colorAsArray[1] - tolerance) <= this.g && (colorAsArray[1] + tolerance) >= this.g && (colorAsArray[2] - tolerance) <= this.b && (colorAsArray[2] + tolerance) >= this.b && (colorAsArray[3] - tolerance) <= this.a && (colorAsArray[2] + tolerance) >= this.a) {
        return true;
      } else {
        return false;
      }
